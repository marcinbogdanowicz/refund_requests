...
class SignUpViewTests(TestCase):
    ...
    def test_signup_page_loads_correctly(self):
        ...
        self.assertIsInstance(
            response.context['user_form'], CustomUserCreationForm
        )
        self.assertIsInstance(
            response.context['profile_form'], UserProfileCreationForm
        )
    ...
    def test_successful_signup(self):
        ...
        self.assertEqual(
            profile.phone_number, self.valid_data['profile-phone_number']
        )
...
class LoginViewTests(TestCase):
    ...
    def test_login_page_uses_bootstrap_form(self):
        ...
        self.assertIsInstance(
            response.context['form'], BootstrapAuthenticationForm
        )
...
class PasswordResetTests(TestCase):
    ...
    def test_password_reset_page_loads_correctly(self):
        ...
        self.assertIsInstance(
            response.context['form'], BootstrapPasswordResetForm
        )
    ...
    def test_password_reset_complete_workflow(self):
        with self.settings(
            ...
            self.assertIsInstance(
                response.context['form'], BootstrapSetPasswordForm
            )
