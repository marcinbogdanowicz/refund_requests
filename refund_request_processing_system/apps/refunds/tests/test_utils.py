...
class IBANValidatorTests(ClearCacheTestMixin, TestCase):
    ...
    def test_service_unavailable_raises_error(self, mock_validate):
        ...
        with self.assertRaisesRegex(RuntimeError, "Validation service is unavailable."):
            self.validator.get_error()
    ...
    def test_country_case_insensitive(self):
        ...
        with patch("apps.refunds.utils.APINinjasClient.validate_iban") as mock_validate:
            mock_validate.return_value = {"valid": True, "country": "DE"}
